  ...
  <table class="table table-bordered summary-report-pol">
    <thead>                  
      ...
      for( $i = 0; $i < count($branches); $i++) {
        ...
        //здесь будем писать
        // $project_all[$i] = $facurr; //заполняем массив данными всего по филиалам 
        $project_comleted[$i] = $fbcurr; //заполняем массив завершенными по филиалам
        $project_inwork[$i] = $facurr - $fbcurr; //заполняем массив данными в работе по филиалам 
    ...
    $branch_name[$i] = $branches[$i]->name; //просто массив с названиями филиалов
