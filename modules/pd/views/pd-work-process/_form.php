...
<div class="pd-work-process-form">
    ...
    <?= $form->field($model, 'pd_step')->dropDownList(ArrayHelper::map(app\modules\pd\models\PdStep::find()->orderBy(['sort_order' => SORT_ASC])->all(), 'id', 'step_name')) ?>
...
*/
    ...
    <div class="bottom_file "> <label class="control-label">Загрузка документа для отчета(pdf, docx/doc, xlsx/xls, rar/7z/zip) </label> <?= $form->field($model2, 'pdProcess')->fileInput(['id' => 'pdProcess'])->label(false) ;?></div>
