...
$this->title = 'Информация о экспертизах';
...
?>
<div class="audit-expertise-view">
    <p>
    ...
    echo '<div><h5 class="textBold"> Договор на экспертизу: <h5 class="Text">'.$model->contract.'</h5></h5></div>' ;
    echo '<div><h5 class="textBold"> Сумма договора: <h5 class="Text">'.$model->sum_contract.'</h5></h5></div>' ;
