...
$this->title = 'Информация о внеплановых ревизии';
...
<div class="audit-revision-view">
 <p>
    ...
    echo '<div><h5 class="textBold"> Проверяющий орган: </h5><h5 class="Text">'.$model->inspectorate.'</h5></div>';
    echo '<div><h5 class="textBold"> ФИО и должность исполнителя: <h5 class="Text">'.$model->fio.'</h5></h5></div><br>' ;
...
//    echo '<div><h5 class="textBold"> Предложения: </h5><h5 class="Text">'.$model->proposal.'</h5></div><br>';
    ...
    <div class="inspectionInformation"><h5>Информация об итогах проведенной проверки</h5><div class="floatNo file_list"></div></div>
    <div class="responseOrder"><h5>Ответ на предписание по итогам проверки</h5><div class="floatNo file_list"></div></div>
