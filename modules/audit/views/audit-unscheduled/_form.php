...
?>
<style>
    #auditunscheduled-comment, #auditunscheduled-proposal {
        height: 168px;
    }
</style>
    <p>
        <?= Html::a('<- вернуться к списку внеплановых проверкок', ['../audit/audit-unscheduled/' ], ['class' => 'btn btn-primary']); ?>
    </p>




<div class="audit-unscheduled-form">
...
if(isset($model2)) {
    ...
    <div class="row" style="margin-bottom: 15px">
        <div class="col-sm-12"><h3>Файлы по внеплановой проверки(.pdf, .doc, .docx)</h3></div>
...
$js = <<<JS
    ...
    $('#requestFileForm').on('beforeSubmit', function(e){
      ...
      $.ajax({
        url: '/audit/audit-unscheduled/upload',
        type: 'POST',
        data: formData,
        cache: false,
        dataType: 'json',
