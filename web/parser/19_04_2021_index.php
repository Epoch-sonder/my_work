    ...
    foreach ( $xls->rows() as $r => $row ) {
        ...
        if($not_bd){
            ...
            if ($row[1] == $branch['2'] or $row[1] == $branch['17']) {
                ...
                elseif(strpos("$row[8]", "№ 042/")!== false) $idBranch =  $branches[$branch['16']];
            }

            elseif ($row[1] == $branch['11'] or $row[1] == $branch['33']) {
                if(strpos("$row[8]", "№ 26/") !== false) $idBranch =  $branches[$branch['33']];
                elseif(strpos("$row[8]", "№ 05/") !== false) $idBranch =  $branches[$branch['11']];
            }
            elseif ($row[1] == $branch['4'] or $row[1] == $branch['22']) {
                if(strpos("$row[8]", "(ХМ)") !== false or strpos("$row[8]", "Счет-фактура") !== false) $idBranch =  $branches[$branch['22']];
//                if(strpos("$row[8]", "Счет-фактура") !== false) $idBranch =  $branches[$branch['22']];
            ...
            elseif ($row[1] == $branch['9'] or $row[1] == $branch['29']) {
                if(strpos("$row[8]", "/РК") !== false) $idBranch =  $branches[$branch['29']];
